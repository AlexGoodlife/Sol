...
public class SolLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "INT", "DOUBLE", "STRING", "BOOLEAN", "LSBRACKET", "RSBRACKET", 
			"PRINT", "INT_T", "DOUBLE_T", "STRING_T", "BOOLEAN_T", "TRUE", "FALSE", 
			"BEGIN", "END", "WHILE", "DO", "FOR", "TO", "IF", "THEN", "ELSE", "BREAK", 
			"VOID", "RETURN", "MULT", "ADD", "MINUS", "MOD", "DIV", "LPAREN", "RPAREN", 
			"GT", "LT", "GET", "EQ", "NEQ", "LET", "NOT", "AND", "OR", "REF", "DREF", 
			"IDENTIFIER", "EOL", "WS", "SL_COMMENT", "ML_COMMENT", "DIGIT", "LETTER"
		};
	}
